...
- Borisa Djuraskovic from [Web Hosting Hub](http://www.webhostinghub.com/): Contributed the Serbian translations.
- [Luca Palli](http://lpal.li/): Contributed the Italian translations.
- [joerns](https://wordpress.org/support/profile/joerns): Contributed the code to support the galleries.
